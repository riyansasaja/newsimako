$(document).ready(function () {
...

            {
                ...
                "render": function (data, type, row) {
                    if (row.realisasi_idev >= 1) {
                        return `<a href="javascript:;" class="badge rounded-pill bg-warning item_edit"'>Edit</i></a>`;
                    } else {
                        return `<a href="javascript:;" class="badge rounded-pill bg-primary item_edit"'>Input</i></a>`;
                    }
                }
            }
        ]
    ...
    let show_realisasi_risiko = $('#tb_show_realisasi_risiko').DataTable({
        ...
        "columns": [
            ...
            {
                "data": null,
                "defaultContent": `<a href="javascript:;" id='deleteprogram' class="badge rounded-pill bg-danger item_delete"'>Delete</a>`
            }
        ]
    });
