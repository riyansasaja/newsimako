$(document).ready(function () {
    ...
    let showkegiatan = $('#showkegiatan').DataTable({
        ...
        "columns": [
            ...
            {
                "data": null,
                "defaultContent": `<a href="javascript:;" id='editkegiatan' class="item_edit badge rounded-pill bg-warning mb-2">Edit</a>
                <a href="javascript:;" id='editkegiatan' class="item_delete badge rounded-pill bg-danger mb-2">Hapus</a>
               `
            }
        ]
    });
    ...
    let showprogram = $('#showprogram').DataTable({
        ...
        "columns": [
            ...
            {
                "data": null,
                "defaultContent": `<a href="javascript:;" class="badge rounded-pill bg-warning mb-2 item_edit"'>Edit</a>
                <a href="javascript:;" id='deleteprogram' class="badge rounded-pill bg-danger mb-2 item_delete px-2">Delete</a>`
            }
        ]
    });
    // -----
