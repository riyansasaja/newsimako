$(document).ready(function () {
    ...
    let listriwayat = $('#table-listriwayat').DataTable({
        ...
        "columns": [
            ...
            {
                "data": null,
                "defaultContent": `<a href="javascript:;" id='view' class="badge rounded-pill bg-primary item_view"'>Detail</a> <br>
                <a href="javascript:;" id='edit' class="badge rounded-pill bg-warning item_edit"'>edit</a> <br>
                <a href="javascript:;" id='delete' class="badge rounded-pill bg-danger item_delete"'>Hapus</a>`
            }
        ],
