$(document).ready(function () {
    ...
    const path = `${prapath}/minsel/inspektorat/`;
    ...
    let table = $('#example').DataTable({
        ...
        "columns": [
            ...
            {
                "data": null,
                "defaultContent": `<a href="javascript:;" id='tes' class="badge rounded-pill bg-success item_edit"'>Edit</a>
            <a href="javascript:;" id='tes' class="badge rounded-pill bg-danger item_delete"'>Delete</a>`
            }
        ]
    });
    ...
    let tbsk = $('#tbsk').DataTable({
        ...
        "columns": [
            ...
            {
                "data": null,
                "defaultContent": `<a href="javascript:;" id='tes' class="badge rounded-pill bg-danger item_delete"'>Delete</a>`
            }
        ]
    });
