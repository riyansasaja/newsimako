...
class Bidang extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        is_logged_in();
        $this->load->model('Modelbidang', 'model');
    }
    ...
    public function geTK()
    {
        ...
        $data['data'] = $this->db->get_where('tb_tujuan_kegiatan', ['kode_unor' => $id, 'tahun_anggaran' => $tahun_anggaran])->result();
    ...
    {
        $id = $this->session->userdata('id');
        $data['list'] = $this->model->getlist($id);
    ...
    {
        $data['list'] = $this->model->getprogrambyid($id_tk);
        $data['ref_risk'] = $this->model->getrefrisk($id_tk);
        $data['title'] = 'Input Analisis Risiko';
    ...
    public function seveidev()
    {
        ...
        $data['data'] = $this->model->m_saveidev($id_user, $id_atasan);
        echo json_encode($data);
    }
    ...
    public function inputrtp($id_idev)
    {
        ...
        $data['rtp'] = $this->model->getrtp($id_idev);
        $data['js'] = 'inputrtp.js';
        $this->load->view('templates/header', $data);
    ...
    {
        $data = $this->model->m_savertp();
        echo json_encode($data);
    }

    public function edit_rtp()
    {
        $data = $this->model->m_editrtp();
        echo json_encode($data);
    }
    ...
    //         $data['resiko'] = $this->model->getrtp($id_idev);
    //         $data['rtp'] = $this->model->get_rtp($id_idev);
    //         $data['realisasi'] = $this->model->get_realisasi($id_idev);
    ...
    public function get_realisasi_tk()
    {
        $id = $this->session->userdata('id');
        $tahun_anggaran = $this->session->userdata('tahun_anggaran');
        $data['data'] = $this->db->get_where('tb_tujuan_kegiatan', ['kode_unor' => $id, 'realisasi' => 1, 'tahun_anggaran' => $tahun_anggaran])->result_object();
        echo json_encode($data);
    }
    ...
    {
        $id_user = $this->session->userdata('id');
        $data['data'] = $this->model->get_all_idev($id_user);
        echo json_encode($data);
    }
    ...
    {
        $id_user = $this->session->userdata('id');
        $data['data'] = $this->model->get_all_idev_realisasi($id_user);
        echo json_encode($data);
    }
    ...
    {
        $id_user = $this->session->userdata('id');
        $data['data'] = $this->model->get_all_rtp($id_user);
        echo json_encode($data);
    }
    ...
    {
        $id_user = $this->session->userdata('id');
        $data['data'] = $this->model->get_all_realisasi_rtp($id_user);
        echo json_encode($data);
    }
