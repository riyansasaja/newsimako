...
class Exportrealisasiexcel extends CI_Controller
{
    ...
    public function cetak_realisasi_bidang($id)
    {
        ...
        $sheet2->setCellValue('B5', 'PROGRAM');
        $sheet2->mergeCells('C5:C6');
        $sheet2->setCellValue('C5', 'KEGIATAN');


        $sheet2->mergeCells('D5:D6');
        $sheet2->setCellValue('D5', 'RISIKO');
        $sheet2->mergeCells('E5:G5');
        $sheet2->setCellValue('E5', 'RENCANA TINDAK PENGENDALIAN (RTP)');
        $sheet2->mergeCells('H5:I5');
        $sheet2->setCellValue('H5', 'REALISASI RTP');

        $sheet2->setCellValue('E6', 'URAIAN');
        $sheet2->setCellValue('F6', 'TARGET_WAKTU');
        $sheet2->setCellValue('G6', 'PJ');
        $sheet2->setCellValue('H6', 'URAIAN');
        $sheet2->setCellValue('I6', 'TARGET_WAKTU');
        $sheet2->setCellValue('J6', 'PJ');
        ...
        foreach ($realisasi_rtp as $rrtp) {
            ...
            $sheet2->setCellValue('B' . $x, $rrtp['program']);
            $sheet2->setCellValue('C' . $x, $rrtp['kegiatan']);
            $sheet2->setCellValue('D' . $x, $rrtp['resiko']);
            $sheet2->setCellValue('E' . $x, $rrtp['uraian_rtp']);
            $sheet2->setCellValue('F' . $x, $rrtp['target_waktu']);
            $sheet2->setCellValue('G' . $x, $rrtp['pj']);
            $sheet2->setCellValue('H' . $x, $rrtp['realisasi_uraian']);
            $sheet2->setCellValue('I' . $x, $rrtp['realisasi_target_waktu']);
            $sheet2->setCellValue('J' . $x, $rrtp['realisasi_pj']);
            $x++;
        }
        ...
        $sheet1->getStyle('A5:J' . $y)->applyFromArray($styleArray);
        $sheet2->getStyle('A5:J' . $y)->applyFromArray($styleArray);
    ...
    public function cetak_realisasi_all()
    {
        ...
        $sheet2->setCellValue('A5', 'NO');
        $sheet2->mergeCells('B5:B6');
        $sheet2->setCellValue('B5', 'UNIT');
        $sheet2->mergeCells('C5:C6');
        $sheet2->setCellValue('C5', 'PROGRAM');
        $sheet2->mergeCells('D5:D6');
        $sheet2->setCellValue('D5', 'KEGIATAN');
        $sheet2->mergeCells('E5:E6');
        $sheet2->setCellValue('E5', 'RISIKO');

        $sheet2->mergeCells('F5:H5');
        $sheet2->setCellValue('F5', 'RENCANA TINDAK PENGENDALIAN (RTP)');
        $sheet2->mergeCells('I5:K5');
        $sheet2->setCellValue('I5', 'REALISASI RTP');

        $sheet2->setCellValue('F6', 'URAIAN');
        $sheet2->setCellValue('G6', 'TARGET_WAKTU');
        $sheet2->setCellValue('H6', 'PJ');
        $sheet2->setCellValue('I6', 'URAIAN');
        $sheet2->setCellValue('J6', 'TARGET_WAKTU');
        $sheet2->setCellValue('K6', 'PJ');
        ...
        foreach ($realisasi_rtp as $rrtp) {
            ...
            $sheet2->setCellValue('A' . $c, $no++);
            $sheet2->setCellValue('B' . $c, $rrtp['name']);
            $sheet2->setCellValue('C' . $c, $rrtp['program']);
            $sheet2->setCellValue('D' . $c, $rrtp['kegiatan']);
            $sheet2->setCellValue('E' . $c, $rrtp['resiko']);
            $sheet2->setCellValue('F' . $c, $rrtp['uraian_rtp']);
            $sheet2->setCellValue('G' . $c, $rrtp['target_waktu']);
            $sheet2->setCellValue('H' . $c, $rrtp['pj']);
            $sheet2->setCellValue('I' . $c, $rrtp['realisasi_uraian']);
            $sheet2->setCellValue('J' . $c, $rrtp['realisasi_target_waktu']);
            $sheet2->setCellValue('K' . $c, $rrtp['realisasi_pj']);
            $c++;
        }
        ...
        $sheet1->getStyle('A5:I' . $y)->applyFromArray($styleArray);
        $sheet2->getStyle('A5:K' . $z)->applyFromArray($styleArray);
