...
class Exportexcel extends CI_Controller
{
    ...
    public function cetaktkall()
    {
        ...
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        $sheet->setCellValue('A1', 'TABEL TUJUAN KEGIATAN');
        $sheet->setCellValue('A2', 'PEMERINTAH KOTA :' . strtoupper($data[0]['nama_pemkot']));
        ...
        $writer = new Xlsx($spreadsheet);
        $filename = 'Laporan tujuan kegiatan ' . $data[0]['nama_pemkot'];
